...
def run_NSGA3(perms, offspring=100, pop_size=50, tol=0.002, n_last=8, n_max_gen=200):
    ...
    ref_dirs = get_reference_directions("das-dennis", 2, n_partitions=10, scaling=10.0)
